...
const Login = () => {
 ...
 hover:border-blue-400 focus:bg-blue-50 active:bg-blue-100">
                        ...
                        <form onSubmit={handleSubmit} action="">
                            ...
                            <button
                                type="submit"
                                className="w-full text-center py-3 rounded bg-cyan-500 text-white hover:bg-gray-600 focus:outline-none my-1"
                            >Log In</button>
                        </form>
                        {/* reset option */}
                        <div className='text-center'>
                            <button
                                ...
                                className=' font-bold hover:underline text-red-200'
                            >
                                Forgot password?
                            </button>
                        </div>
                    ...
                    <div className=" mt-6 ">
                        ...
                        <Link to="/register" className="no-underline text-cyan-600 font-bold text-xl " >
                            Register Now
                        </Link>
                    </div>
